...
document.addEventListener("visibilitychange", () => {
  audio[document.hidden ? "pause" : "play"]();
});
window.addEventListener("beforeunload", () => audio.pause());

// Productos
const productos = [
  {nombre:"Pestilencia – Las Nuevas Aventuras de / La Muerte un Compromiso de Todos", descripcion:"CD doble. Punk metal colombiano histórico.", precio:90000, imagen:"pestilencia.jpg", stock:1},
  {nombre:"Los Sordos – Rock and Roll Obrero", descripcion:"Punk obrero colombiano. Edición 10 años.", precio:50000, imagen:"lossordos.jpg", stock:1},
  {nombre:"Sarcófago – Live 1987–1991", descripcion:"Black/death metal brasileño en vivo.", precio:120000, imagen:"sarcofago.jpg", stock:1},
  {nombre:"Demised – Death Metal", descripcion:"Death metal venezolano underground.", precio:50000, imagen:"demised.jpg", stock:1}
];
